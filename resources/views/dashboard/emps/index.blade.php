                    ...
                    <div class="card-body px-1">
                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5"><label for="name"
                               ...
                               <div class="form-group " onclick='show_job_cat(1,"{{ route("dashboard.emps.show_job_cat") }}")' data-url="{{ route('dashboard.emps.show_job_cat') }}">
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                    <label for="email" class="form-label required fs-6 fw-bold text-dark mb-3">البريد
                                        الإلكتروني</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                    <label for="password" class="form-label required fs-6 fw-bold text-dark mb-3">كلمة
                                        المرور</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5 role_per_div" id="role_per_div" style="display:none" >
                                    <label for="role_per" class="form-label required fs-6 fw-bold text-dark mb-3">مجموعة الصلاحية</label>
                                    <div>
                                ...
                                <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5 manager_div" id="manager_div" style="display:none" >
                                ...
                                <div class=" col-12 col-lg-12 col-md-12 col-sm-12  mb-5">
                                    <label for="note" class="  form-label fs-6 fw-bold text-dark mb-3" row='1'>الملاحظة
                                    </label>
