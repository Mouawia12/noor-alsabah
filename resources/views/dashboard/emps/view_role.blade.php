...
@section('content')
    ...
    <form class="kt-form kt-form--label-right" enctype="multipart/form-data" id="boew_project" name="boew_project"
        accept-charset="utf-8" method="post" action="{{ route('dashboard.emps.tbl_role') }}" enctype="multipart/form-data">
        @csrf
        <div class="d-flex flex-column flex-lg-row">
            <div class="flex-lg-row-fluid mb-0 mb-lg-0 ">
                <div class="card">
...
ادارة المجموعات
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a  href="{{ route('dashboard.emps.add_role') }}" type="button" class="btn btn-primary" >
                    ...
                    <div class="card-body px-1">
                                ...
                                <div id="result_role_tbl" name="result_role_tbl"></div>
...
@section('scripts')
    ...
    <script>
    view_all_role("{{ route('dashboard.emps.tbl_role') }}");
        ...
        function del_role(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.emps.del_role') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
