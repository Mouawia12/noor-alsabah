...
<form id="upd_manager_data" name="upd_manager_data" class="form" action="{{ route('dashboard.manager.updstore') }}"
    method="post" enctype="multipart/form-data" autocomplete="off">
    @csrf


    <input name="manager_id_db" id="manager_id_db" value="{{ $manager->manager_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="manager_id_db"
            ...
            <div class="card">
                <div class="card-body ">
                    ...
                    <div class="alert alert-dismissible bg-success d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                        id="successBox_manager" style="display: none !important">
                        <span class="svg-icon svg-icon-2hx svg-icon-light me-4 mb-5 mb-sm-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path opacity="0.3"
                        ...
                        <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                            ...
                            <span id="displaysuccess_manager"></span>
                        </div>
                        <button type="button"
                            class="position-absolute position-sm-relative m-2 m-sm-0 top-0 end-0 btn btn-icon ms-sm-auto"
                            data-bs-dismiss="alert">
                    ...
                    <div class="mb-0">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                ...
                                type="text" name="manager_name" id="manager_name" value="{{$manager->manager_name}}"
                    ...
                    <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                ...
                                type="text" name="manager_mobile" id="manager_mobile" value="{{$manager->manager_mobile}}"
                    ...
                    <div class=" col-12 col-lg-6 col-md-12 col-sm-12  mb-5">
                        ...
                        <textarea name="note" rows="1" class="form-control fw-bold" id="note" placeholder="الملاحظة">{{$manager->note}}</textarea>
                    </div>
...
@section('styles')
    ...
    <script>
        ...
        function del_file_multi(manager_id,ssnfile_url,type,i) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.manager.delete_file') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
        ...
        function del_file(manager_id, ssnfile_url, type) {
            swal.fire({
                text: 'هل انت متأكد من الحذف',
                icon: 'warning',
                buttonsStyling: false,
