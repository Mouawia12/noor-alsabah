...
@section('content')
    ...
    <form class="kt-form kt-form--label-right" enctype="multipart/form-data" id="boew_project" name="boew_project"
        accept-charset="utf-8" method="post" action="{{ route('dashboard.manager.tbl') }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body px-1">
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                <div class=" col-12 col-lg-4 col-md-12 col-sm-12 mb-5"><label for="manager_name_v"
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="manager_name_v" id="manager_name_v"
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="manager_mobile_v" class="form-label  fs-6 fw-bold text-dark mb-3">رقم جوال القائد</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="fas fa-phone-volume fa-fw text-dark"></i></span></div><input
                                        type="text" name="manager_mobile_v" id="manager_mobile_v"
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12   mb-5"
                                    ...
                                    <a onclick="view_all_manager()" class="btn btn-primary btn-primary--icon"
                                        id="kt_search">
                                        <span>
                        ...
                        <div id="result_manager_tbl" name="result_manager_tbl">
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript"
        src="{{ asset('assets/module/manager_j.js') }}?t={{ config('global.ver.version_all') }}"></script>
    <script>
        view_all_manager("{{ route('dashboard.manager.tbl') }}");
        function del_manager (id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.manager.del_manager') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
