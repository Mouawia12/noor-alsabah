...
<form id="upd_statement_data" name="upd_statement_data" class="form" action="{{ route('dashboard.calculate.updstatement') }}"
    ...
    <input name="calculate_id_db" id="calculate_id_db" value="{{ $calculate->calculate_id }}" im-insert="true"
        ...
        <input name="shop_id" id="shop_id" value="{{ $calculate->shop_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        ...
        <input name="calculate_month_desc" id="calculate_month_desc" value="{{ $calculate->calculate_month_desc }}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="calculate_month_desc"
        aria-describedby="basic-addon1">


        <input name="calculate_month_y" id="calculate_month_y" value="{{ $calculate->calculate_month_y }}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="calculate_month_y"
        aria-describedby="basic-addon1">

        <input name="calculate_month_m" id="calculate_month_m" value="{{ $calculate->calculate_month_m}}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="calculate_month_m"
        aria-describedby="basic-addon1">
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            ...
            <div class="card">
                ...
                <div class="row p-0 mb-0 px-1">
                    ...
                    <div class="col">
                        <div class="border border-dashed border-dark text-center min-w-125px  rounded pt-4 pb-2 my-3">
                            <span class="fs-6 fw-bold text-danger ">شهر الدفع:</span> <span class=" fw-bold text-dark ">{{ $calculate->calculate_month_desc}}</span> 																	<!--<span class="fs-6hx  text-gray-900 counted" data-kt-countup="true" data-kt-countup-value="72">{{ session('user_id')}} </span>-->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5" id='show_details'>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5" style="display:none">
                                <label for="calculate_detail_id" class="form-label required fs-6 fw-bold text-dark mb-3">calculate_detail_id</label>
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        class="form-control fw-bold text-dark text-info form-control-solid"
                                        data-inputmask="'alias' : 'decimal'" minlenght="1" maxlength="20" value="{{ $last_calculate_month_remain }}"
                                        placeholder="المبلغ المطلوب ">
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="calculate_month_pay" id="calculate_month_pay"
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="calculate_month_remain" id="calculate_month_remain"
                    ...
                    <div id="result_calculate_detail_tbl" name="result_calculate_detail_tbl"></div>
                </div>
            </div>
        </div>
...
<script>
        view_all_calculate_detail("{{ route('dashboard.calculate.tbl_detail') }}");



        function del_calculate_det(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.calculate.del_calculate_det') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
