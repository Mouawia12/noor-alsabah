...
@section('content')
    ...
    <form class="kt-form kt-form--label-right" enctype="multipart/form-data" id="boew_project" name="boew_project"
        accept-charset="utf-8" method="post" action="{{ route('dashboard.calculate.tbl') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
                <div class="card">
                    <div class="card-body px-1">
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                {{-- <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="calculate_month_desc_v" class="form-label required fs-6 fw-bold text-dark mb-3">شهر الدفع
                                        :</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                            type="text" name="calculate_month_desc_v" id="calculate_month_desc_v" value="{{$nowmonth}}"
                                ...
                                <div class="col-12 col-lg-4 col-md-12 col-sm-12   mb-5"
                                    ...
                                    <a onclick="view_all_calculate()" class="btn btn-primary btn-primary--icon"
                                        id="kt_search">
                                        <span>
                                 ...
                                 <a  class="btn btn-danger btn-danger--icon"  href="{{ route('dashboard.calculate.cronadd') }}">
                                    <span>
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_calculate_pdf') }}'
                                               onclick="print_calculate_pdf('')" class="menu-link px-3 text-dark print_calculate_pdf "><span><i
                                                        class="far fa-file-pdf fa-fw text-danger"></i></span> طباعة PDF
                                            </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_calculate_xlsx') }}'
                                               onclick="print_calculate_xlsx('')"
                                               class="menu-link px-3 text-dark print_calculate_xlsx"><span><i
                        ...
                        <div id="result_calculate_tbl" name="result_calculate_tbl">
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        view_all_calculate("{{ route('dashboard.calculate.tbl') }}");
        function del_calculate (id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.calculate.del_calculate') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
