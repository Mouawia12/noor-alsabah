...
@section('content')
    ...
    <form id="save_workplace" name="save_workplace" class="form" action="{{ route('dashboard.constant.storeworkplace') }}"
                ...
                <div class="card">
                    <div class="card-body px-1">
                        <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                            id="errorBox_workplace" style="display: none !important">
                            ...
                            <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                                <span id="displayErrors_workplace" class="mb-2  fw-bolder text-light"></span>
                            </div>
                            <button type="button"
                        ...
                        <div class="mb-0">
                            ...
                            <div class=" col-12 col-lg-4 col-md-12 col-sm-12 mb-5"><label for="work_place_name"
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="work_place_name" id="work_place_name"
                                        class="form-control fw-bolder  text-dark" placeholder="مكان العمل" value=""
                                        autocomplete="off">
                                </div>
                            </div>
                    ...
                    <div id="result_workplace_tbl" name="result_workplace_tbl"></div>
...
<script>
    view_all_workplace("{{ route('dashboard.constant.tblworkplace') }}");

    function del_workplace(id) {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('dashboard.constant.delworkplace') }}",
                    'type': 'POST',
                    'dataType': 'json',
                    'async': false,
                    'data': {
