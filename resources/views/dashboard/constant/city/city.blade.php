...
@section('content')
    ...
    <form id="save_city" name="save_city" class="form" action="{{ route('dashboard.constant.storecity') }}"
                ...
                <div class="card">
                    <div class="card-body px-1">
                        <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6"
                            id="errorBox_city" style="display: none !important">
                            ...
                            <div class="d-flex flex-column text-light pe-0 pe-sm-10">
                                <span id="displayErrors_city" class="mb-2  fw-bolder text-light"></span>
                            </div>
                            <button type="button"
                        ...
                        <div class="mb-0">
                            ...
                            <div class=" col-12 col-lg-4 col-md-12 col-sm-12 mb-5"><label for="city_name"
                                    class="form-label required fs-6 fw-bold text-dark mb-3">المدينة</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="fas fa-user-tie fa-fw text-dark "></i></span></div><input
                                        type="text" name="city_name" id="city_name"
                                        class="form-control fw-bolder  text-dark" placeholder="المدينة" value=""
                                        autocomplete="off">
                                </div>
                            </div>
                    ...
                    <div id="result_city_tbl" name="result_city_tbl"></div>
...
<script>
    view_all_city("{{ route('dashboard.constant.tblcity') }}");
    ...
    function del_city(id) {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('dashboard.constant.delcity') }}",
                    'type': 'POST',
                    'dataType': 'json',
                    'async': false,
                    'data': {
