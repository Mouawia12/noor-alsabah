...
<form id="upd_remark_data" name="upd_remark_data" class="form" action="{{ route('dashboard.shop.updremark') }}" method="post"
            ...
            <div class="card">
                <div class="card-body ">
                    ...
                    <div class="separator separator-content border-dark my-10 mb-8"><span
                        class="w-150px fw-bold text-danger">عرض الملاحظات</span></div>
                    <div id="result_remark_tbl" name="result_remark_tbl"></div>
...
view_all_reamrk("{{ route('dashboard.shop.tbl_remark') }}");
function del_remark(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.shop.del_remark') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
