...
<form id="upd_moraslat_data" name="upd_moraslat_data" class="form" action="{{ route('dashboard.moraslat.updstore') }}"
    ...
    <script type="text/javascript"         src="{{ asset('assets/module/moraslat_j.js') }}?t={{ config('global.ver.version_all') }}"></script>
