...
<form id="upd_statement_data" name="upd_statement_data" class="form" action="{{ route('dashboard.expense.updstatement') }}"
    ...
    <input name="expense_id_db" id="expense_id_db" value="{{ $expense->expense_id }}" im-insert="true"
        ...
        <input name="shop_id" id="shop_id" value="{{ $expense->shop_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        ...
        <input name="expense_month_desc" id="expense_month_desc" value="{{ $expense->expense_month_desc }}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="expense_month_desc"
        aria-describedby="basic-addon1">


        <input name="expense_month_y" id="expense_month_y" value="{{ $expense->expense_month_y }}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="expense_month_y"
        aria-describedby="basic-addon1">

        <input name="expense_month_m" id="expense_month_m" value="{{ $expense->expense_month_m}}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="expense_month_m"
        aria-describedby="basic-addon1">
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            ...
            <div class="card">
                ...
                <div class="row p-0 mb-0 px-1">
                    <!--begin::Col-->
                    <div class="col">
                        <div class="border border-dashed border-dark text-center min-w-125px rounded pt-4 pb-2 my-3">
                            <span class="fs-6 fw-bold text-danger ">اسم المحل :</span> <span class=" fw-bold text-dark ">{{ $shop->shop_name}}</span> 																	<!--<span class="fs-6hx  text-gray-900 counted" data-kt-countup="true" data-kt-countup-value="36899">{{ session('Name') }}</span>-->
                        </div>
                    </div>
                    <div class="col">
                        <div class="border border-dashed border-dark text-center min-w-125px  rounded pt-4 pb-2 my-3">
                            <span class="fs-6 fw-bold text-danger ">شهر الدفع:</span> <span class=" fw-bold text-dark ">{{ $expense->expense_month_desc}}</span> 																	<!--<span class="fs-6hx  text-gray-900 counted" data-kt-countup="true" data-kt-countup-value="72">{{ session('user_id')}} </span>-->
                        </div>
                    </div>
                </div>
                    <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6" id="errorBox_statement"  style="display: none !important">
                        ...
                        <div class="d-flex flex-column text-light pe-0 pe-sm-10" >
                            <span id="displayErrors_statement" class="mb-2  fw-bolder text-light"></span>
                        </div>
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5" id='show_details'>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5" style="display:none">
                                <label for="expense_detail_id" class="form-label required fs-6 fw-bold text-dark mb-3">expense_detail_id</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="expense_detail_id" id="expense_detail_id" readonly
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="expense_month_val" class="form-label required fs-6 fw-bold text-dark mb-3">المبلغ
                                    المطلوب</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="expense_month_val" id="expense_month_val" readonly
                                        class="form-control fw-bold text-dark text-info form-control-solid"
                                        data-inputmask="'alias' : 'decimal'" minlenght="1" maxlength="20" value="{{ $last_expense_month_remain }}"
                                        placeholder="المبلغ المطلوب ">
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="expense_month_pay" class="form-label required fs-6 fw-bold text-dark mb-3">المبلغ
                                    المدفوع</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="expense_month_pay" id="expense_month_pay"
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="expense_month_remain" class="form-label required fs-6 fw-bold text-dark mb-3">المبلغ
                                    المتبقي</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="expense_month_remain" id="expense_month_remain"
                            ...
                            <div class=" col-12 col-lg-6 col-md-12 col-sm-12  mb-5">
                                ...
                                <textarea name="note"  row='1' class="form-control fw-bold" id="note" placeholder="ملاحظة"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="separator separator-content border-dark my-10 mb-8"><span
                        class="w-150px fw-bold text-danger">عرض الاقساط</span></div>
                    <div id="result_expense_detail_tbl" name="result_expense_detail_tbl"></div>
                </div>
            </div>
        </div>
...
<script>
        view_all_expense_detail("{{ route('dashboard.expense.tbl_detail') }}");



        function del_expense_det(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.expense.del_expense_det') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
...
var expense_month_val_v= parseFloat($('#expense_month_val').val());
var expense_month_pay_v = parseFloat($('#expense_month_pay').val());

var expense_month_remain_v = parseFloat($('#expense_month_remain').val());
if (isNaN(expense_month_val_v)) {
    expense_month_val_v = 0;
    $('#expense_month_val').val(0);
}
if (isNaN(expense_month_pay_v)) {
    expense_month_pay_v = 0;
    $('#expense_month_pay').val(0);
}
expense_month_remain_v = expense_month_val_v - expense_month_pay_v;
...
function sel_shop_pay() {
    ...
    if(shop_id!=''){
$('#expense_month_val').val('');
$('#expense_month_remain').val('');
$.ajax({
...
$('#expense_month_val').val('');
$('#expense_month_pay').val('');
$('#expense_month_remain').val('');
}
else{
$('#expense_month_val').val(resp.expense_month_val);
calc_all_price() ;
...
function chk_expense_shop(month,year) {
    let  shop_id  = $('#shop_id').val();
    let  expense_month_desc  = $('#expense_month_desc').val();
if(expense_month_desc!=''){
    let arr = expense_month_desc.split('-');
    let month_val =  arr[0];
    let year_val  =  arr[1];
    alert(month_val);
var month=month_val;
var year=year_val;
    ...
    if(shop_id!=''){
$.ajax({
url: " {{ route('dashboard.general.chk_expense_shop') }}",
dataType: 'json',
type: 'POST',
async: false,
'data': {
...
$('#payments_month_val').val(resp.payments_month_val);
$("#errorBox_expense").show();
$("#displayErrors_expense").html('');
...
$(document).ready(function() {
    ...
    onChange: function(selectedDates, dateStr, instance) {
        chk_expense_shop(selectedDates[0].getMonth() + 1,selectedDates[0].getFullYear())
  },
