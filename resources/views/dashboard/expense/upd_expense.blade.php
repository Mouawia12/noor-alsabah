                    ...
                    <div class="mb-0">
                        ...
                        <div class="row gx-5 mb-5">
                            <div class="col-12 col-lg-5 col-md-12 col-sm-12 mb-5">
                                <label for="expense_type_id" class="form-label   fs-6 fw-bolder text-danger mb-3">نوع المصروف</label>
                                <div>
                                    <select class="form-select fw-bolder text-danger expense_type_id form-select_u " data-control="select2" id="expense_type_id"
                                        name="expense_type_id" dir="rtl" onchange='load_expense_form(this.value,2)'   data-url="{{ route('dashboard.expense.load_expense_form') }}" >
                                        <option value="">اختر ..</option>

                                        @foreach ($expense_type as $x)
                                            <option  @selected($expense->expense_type_id == $x->expense_type_id)  value="{{ $x->expense_type_id }} ">{{ $x->expense_type_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row gx-5 mb-5" id='load_expense_form'></div>
