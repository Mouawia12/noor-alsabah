                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                    <label for="expense_type_id_v" class="form-label   fs-6 fw-bold text-dark mb-3">نوع
                                        المصروف</label>
                                    <div>
                                        <select class="form-select fw-bold  " data-control="select2" id="expense_type_id_v"
                                            ...
                                            @foreach ($expense_type as $x)
                                                <option value="{{ $x->expense_type_id }} ">{{ $x->expense_type_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                {{-- <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="expense_type_id_v" class="form-label   fs-6 fw-bold text-dark mb-3">نوع
                                        المصروف</label>
                                    <div>
                                        <select class="form-select fw-bold  " data-control="select2" id="type_v"
                                            name="type_v" dir="rtl">
                                            <option value="">الكل</option>
                                            <option value="1">مصاريف تشغيلية</option>
                                            <option value="2">مصاريف محل</option>
                                            <option value="3">مصاريف عمال</option>
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="expense_type_id_v" class="form-label   fs-6 fw-bold text-dark mb-3">حالة
                                        الدفع</label>
                                    <div>
                                        <select class="form-select fw-bold  " data-control="select2"
                                            id="det_calculate_month_remain_v" name="det_calculate_month_remain_v"
                                            dir="rtl">
                                            <option value="">الكل</option>
                                            <option value="0">مدفوع</option>
                                            <option value="1">متبقي</option>
                                ...
                                {{-- <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="expense_month_desc_v"
                                        class="form-label required fs-6 fw-bold text-dark mb-3">شهر الدفع
                                        :</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                            type="text" name="expense_month_desc_v" id="expense_month_desc_v"
                                            class="form-control fw-bold  text-dark input_date_full_"
                                            value='{{ $nowmonth }}' placeholder="شهر الدفع " value=""
                                            autocomplete="off">
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
                                    <label for="shop_id_v" class="form-label required fs-6 fw-bold text-dark mb-3">اسم
                                        المحل</label>
                                    <div>
                                        <select class="form-select fw-bolder  shop_id_v  " id="shop_id_v" name="shop_id_v"
                                            dir="rtl" data-placeholder="اسم المحل">
                                            <option value="">اختر ..</option>
                                        </select>
                                    </div>
                                </div>
