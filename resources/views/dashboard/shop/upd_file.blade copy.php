                        ...
                        <div class="col">
                            <div
                                ...
                                <span class="fs-6 fw-bold text-info ">اسم المحل :</span> <span
                                    class=" fw-bold text-dark d-block">{{ $shop->shop_name }}</span>
                            </div>
                        </div>
                        <div class="col">
                            <div
                                ...
                                <span class="fs-6 fw-bold text-info ">قائد المحل:</span> <span
                                    class=" fw-bold text-dark d-block">{{ $shop->manager_name }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row gx-5 mb-5">
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="comme_sso" id="comme_sso"
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="fas fa-passport fa-fw text-dark"></i></span></div><input
                                        type="text" name="comme_no" id="comme_no"
                                        class="form-control fw-bold text-dark text-info" minlenght="1"
                            ...
                            <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        type="text" name="comme_sdt" id="comme_sdt"
                            ...
                            <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                        type="text" name="comme_edt" id="comme_edt"
                                        class="form-control fw-bold  text-dark input_date_"
                                        placeholder="تاريخ انتهاء السجل" value="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="comme_city" class="form-label  fs-6 fw-bold text-dark mb-3">المدينة</label>
                                <div>
                            ...
                            <input name="commfile_db" id="commfile_db" value="{{ $shop->comm_attach_url }}"
                                im-insert="true" type="text" style="display:none"
                                class="form-control kt-font-dark kt-font-bolder " readonly
                                placeholder="commfile_db" aria-describedby="basic-addon1">
                                ...
                                <div class="input-group mb-3">
                                    @if ($shop->comm_attach_url)
                                        ...
                                        <a class="btn btn-lg   btn-danger remove"
                                            ...
                                            onclick="del_file('{{ $workers->shop_comm_id }}','{{ $workers->comm_attach_url }}','comme_doc')">
                                            <span>
                                                <i class="fas fa-trash-alt fa-fw " style="color:#fff"></i>
                                            </span>
                                        </a>
                                    @endif
                                    <input class="form-control custom-file-input" type="file" name='commfile'
                                        id='commfile'>
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="calculate_month_val"
                                    class="form-label required fs-6 fw-bold text-dark mb-3">المبلغ
                                    المطلوب</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                        type="text" name="calculate_month_val" id="calculate_month_val"
                                        value="{{ $shop->calculate_month_val }}"
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="manager_id" class="form-label required  fs-6 fw-bold text-dark mb-3">قائد
                                    المحل</label>
                                <div>
                                    <select class="form-select fw-bold  form-select_u" data-control="select2"
                                        ...
                                        @foreach ($manager as $x)
                                            <option @selected($shop->manager_id == $x->manager_id) value="{{ $x->manager_id }} ">
                            ...
                            <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5"><label for="shop_respon"
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        value="{{ $shop->shop_respon }}" class="form-control fw-bold  text-dark"
                                        placeholder="اسم المسؤول" value="" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="shop_mobile" class="form-label  fs-6 fw-bold text-dark mb-3">رقم جوال
                                    المسؤول</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                ...
                                <div>
                                    <select class="form-select fw-bold form-select_u " data-control="select2"
                                        id="city_id" name="city_id" dir="rtl" data-placeholder="المدينة">
                                        <option value="">اختر ..</option>
                                        @foreach ($city as $x)
                                            <option @selected($shop->city_id == $x->city_id) value="{{ $x->city_id }} ">
                                                {{ $x->city_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="shop_location" class="form-label  fs-6 fw-bold text-dark mb-3">موقع
                                    المحل</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
