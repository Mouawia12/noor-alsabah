<input name="shop_note_id" id="shop_note_id" value="{{ $shop_note->shop_note_id }}" im-insert="true"
data-inputmask="'alias' : 'integer' " type="text" style="display:none"
class="form-control kt-font-dark kt-font-bolder " readonly placeholder="shop_note_id"
                ...
                <div>
                    <select class="form-select fw-bold form-select_u " data-control="select2"
                        ...
                        @foreach ($note_type as $x)
                            <option @selected($shop_note->note_type_id==$x->note_type_id) value="{{ $x->note_type_id }} ">{{ $x->note_type_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
...
?>
        ...
        <div class=" col-12 col-lg-12 col-md-12 col-sm-12  mb-5">
            ...
            <textarea name="remark" rows="1" class="form-control fw-bold" id="remark" placeholder="الملاحظة">{{ $shop_note->remark }}</textarea>
        </div>
</div>
