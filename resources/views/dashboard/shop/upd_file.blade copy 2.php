                ...
                <div class="card-body ">
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5">
                            ...
                            <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="comme_sdt" class="form-label  fs-6 fw-bold text-dark mb-3">تاريخ
                                    إصدار السجل</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                            ...
                            <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="comme_edt" class="form-label  fs-6 fw-bold text-dark mb-3"> تاريخ
                                    انتهاء السجل</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                                class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
...
if($emp_job==1){
                        ...
                        <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                            <label for="municip_sdt" class="form-label  fs-6 fw-bold text-dark mb-3">تاريخ إصدار الرخصة</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                        ...
                        <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                            <label for="municip_edt" class="form-label  fs-6 fw-bold text-dark mb-3"> تاريخ انتهاء الرخصة</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
...
if($emp_job==1){
                ...
                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                    ...
                    <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                        <label for="rent_sdt" class="form-label  fs-6 fw-bold text-dark mb-3">تاريخ بداية العقد</label>
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                        class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                    ...
                    <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                        <label for="rent_edt" class="form-label  fs-6 fw-bold text-dark mb-3"> تاريخ نهاية العقد</label>
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                        class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
...
if($emp_job==1){
                   @endphp
                    ...
                    <div id="kt_docs_repeater_rent">
                        <div class="form-group">

    <?php
    if (isset($shop_rentpay)){

    $count_shop_rentpay= count($shop_rentpay);
    $i=1;
    if($count_shop_rentpay==0){
    $rentpay_id="";$rentpay_dt="";$rentpay_price="";$rentpay_note="";

    ?>
                            <div data-repeater-list="kt_docs_repeater_rent">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="rentpay_id" class="form-control "  value="{{$rentpay_id}}"
                                    placeholder="rentpay_id" />
                            </div>
                        </div>
                                        ...
                                        <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text"><i
                                                            class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                                    type="text" name="rentpay_dt" data-control="flatpickr"
                                                    class="form-control fw-bold  text-dark input_date_ flatpickr_u"
                                                    placeholder="تاريخ الدفعة"  autocomplete="off">
                                            </div>
                                        </div>
                        ...
                        <div class="col-12 col-lg-2 col-md-12 col-sm-12   mb-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="rentpay_price" class="form-control "
                        ...
                        <div class="col-12 col-lg-6 col-md-12 col-sm-12   mb-5">
                                    ...
                                    placeholder="ملاحظة" />
                                        ...
                                        <div class="col-md-1">
                                            <a href="javascript:;" data-repeater-delete
                                                ...
                                                <i class="fas fa-trash-alt fa-fw "><span class="path1"></span>
                            ...
                            <?php }  else if($count_shop_rentpay!=0){
                            $ix=0;
                            foreach ($shop_rentpay as $x) {

                                $rentpay_id="";$rentpay_dt="";$rentpay_price="";$rentpay_note="";

                            $rentpay_id=$x->rentpay_id;
                            $rentpay_dt=$x->rentpay_dt;
                            $rentpay_price=$x->rentpay_price;
                            $rentpay_note=$x->rentpay_note;
...
<div data-repeater-list="kt_docs_repeater_rent" id='repetr_{{$rentpay_id}}'>
<div data-repeater-item>
<div class="form-group row mb-5">
            ...
            <div class="col-12 col-lg-2 col-md-12 col-sm-12   mb-5" style="display:none">
<label  class="form-label fs-6 fw-bold text-dark mb-3">ID</label>
<div class="input-group">
<div class="input-group-prepend"><span class="input-group-text"><i
        class="fas fa-dollar-sign fa-fw text-dark"></i></span></div>

<input type="number" name="kt_docs_repeater_rent[<?php echo $ix?> ][rentpay_id]" id="rentpay_id" class="form-control "  value="{{$rentpay_id}}"
placeholder="rentpay_id" />
</div>
</div>
...
<div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
    <label  class="form-label  fs-6 fw-bold text-dark mb-3">تاريخ الدفعة</label>
    <div class="input-group">
        <div class="input-group-prepend"><span class="input-group-text"><i
                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
            type="text"  name="kt_docs_repeater_rent[<?php echo $ix?> ][rentpay_dt]" id="rentpay_dt"   data-control="flatpickr"
            class="form-control fw-bold  text-dark input_date_ flatpickr_u" value="{{$rentpay_dt}}"
            placeholder="تاريخ الدفعة"  autocomplete="off">
    </div>
</div>
...
<div class="col-12 col-lg-2 col-md-12 col-sm-12   mb-5">
<label  class="form-label fs-6 fw-bold text-dark mb-3">مبلغ الايجار</label>
<div class="input-group">
<div class="input-group-prepend"><span class="input-group-text"><i
    class="fas fa-dollar-sign fa-fw text-dark"></i></span></div>

<input type="number" name="kt_docs_repeater_rent[<?php echo $ix?> ][rentpay_price]"  id="rentpay_price"   class="form-control "  value="{{$rentpay_price}}"
placeholder="مبلغ الايجار" />
</div>
</div>
...
<div class="col-12 col-lg-6 col-md-12 col-sm-12   mb-5">
<label class="form-label fs-6 fw-bold text-dark mb-3">ملاحظة</label>
<div class="input-group">
<div class="input-group-prepend"><span class="input-group-text"><i
    class="fas fa-flag-checkered fa-fw text-dark"></i></span></div>

<input type="text" name="kt_docs_repeater_rent[<?php echo $ix?> ][rentpay_note]"  id="rentpay_note"  class="form-control " value="{{$rentpay_note}}"
placeholder="ملاحظة" />
</div>
</div>
    ...
    <div class="col-md-1">
        <a  onclick="del_comm_time(<?php echo $rentpay_id?>)" data-repeater-delete
            class="btn btn-flex btn-sm btn-light-danger mt-3 mt-md-9">
            ...
            حذف
                ...
                <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                    <label for="defence_sdt" class="form-label  fs-6 fw-bold text-dark mb-3">تاريخ إصدار الرخصة</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i
                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                ...
                <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                    <label for="defence_edt" class="form-label  fs-6 fw-bold text-dark mb-3"> تاريخ انتهاء الرخصة</label>
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i
                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
...
if($emp_job==1){
   @endphp
    ...
    aria-describedby="basic-addon1">
<div class=" col-12 col-lg-6 col-md-12 col-sm-12 mb-5">
    <label for="doe" class="form-label  fs-6 fw-bold text-dark mb-3">تحميل صورة من شهادة الكفالة  :</label>
    <div class="input-group mb-3">
...
if($emp_job==1){
                        ...
                        {{-- <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                    type="text" name="mutamar_to_h" id="mutamar_to_h"
                                    class="form-control fw-bold  text-dark "
                                    placeholder="تاريخ انتهاء الرخصة" value="" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                    type="text" name="mutamar_to_g" id="mutamar_to_g"
                                    class="form-control fw-bold  text-dark "
                                    placeholder="تاريخ انتهاء الرخصة" value="" autocomplete="off">
                            </div>
                        </div>
 ...
 --}}
                        ...
                        <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-6 fv-row border border-gray-300">
                            <label
                            class="required form-label required fs-6 fw-bold text-dark mb-3">تاريخ انتهاء الرخصة</label>
                        ...
                        <div class="fw-small fs-7 text-info">هجري او ميلادي</div>
                    </div>
...
var calGer = $.calendars.instance('gregorian', 'ar');
    ...
    $('#mutamar_to_g___').calendarsPicker($.extend({
            calendar: calGer,
            onSelect: function(date) {
                convertDtFromGerToHijri(date, 'mutamar_to_h__');
                $(this).blur();
            },
            defaultDate: '-1d',
            defaultDate: '-1m',
    ...
    $('#mutamar_to_h__').calendarsPicker($.extend({
            calendar: calHj,
            onSelect: function(date) {
                convertDtFromHijriToGer(date, 'mutamar_to_g');
                $(this).blur();
            },
            onClose: function(date) {
                if ($('#mutamar_to_h__').val() == '') {
                    $('#mutamar_to_g__').val('');
                }
                $(this).blur();
            },
    ...
    $('#'+desc_name_h).calendarsPicker($.extend({
            ...
            onClose: function(date) {
                ...
                //    convertDtFromHijriToGer((this).val(), 'mutamar_from_g');
                $(this).blur();
            },
            defaultDate: 'd',
            altFormat: 'D',
    ...
    dt_um('mutamar_to_g','mutamar_to_h');
...
$('#kt_docs_repeater_rent').repeater({
    initEmpty: false,
    ...
    show: function() {
        ...
        $(this).find('[data-kt-repeater="flatpickr"]').flatpickr();
    ...
    ready: function() {
        ...
        $('[data-kt-repeater="flatpickr"]').flatpickr();
...
function del_comm_time(id) {
       ...
       //     title: 'حذف',
        ...
        customClass: {
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('dashboard.shop.del_shop_rentpay') }}",
