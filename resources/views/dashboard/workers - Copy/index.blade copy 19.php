            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
                <div class="card">
                    <div class="card-body px-1">
                        <div class="alert alert-dismissible   d-flex flex-column flex-sm-row w-100 p-5 mb-6" id="errorBox_worker"  style="display: none !important">
                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class=" col-12 col-lg-5 col-md-12 col-sm-12 mb-5"><label for="worker_name"
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="ssn" class="form-label required fs-6 fw-bold text-dark mb-3">رقم الإقامة</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-id-card fa-fw text-dark"></i></span></div><input
                                            type="text" name="ssn" id="ssn"
                                            class="form-control fw-bold text-dark text-info" data-inputmask="'alias' : 'decimal'"

                                            minlenght="1" maxlength="20"
                          ...
                          <!--  <div class="mb-3">
                                ...
                                <input class="form-control custom-file-input" type="file" id="formFileMultiple" multiple="">
                              </div>-->

                              <div class=" col-12 col-lg-5 col-md-12 col-sm-12 mb-5" id="container_file" name="container_file">

                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    <a type="button" id="add_file" class="btn btn-secondary kt-font-info kt-font-bolder" style='border-color:#232b51;'><i class="la la-chain"></i>تحميل أوراق اخرى</a>
                                </div>
                                <br />
                                <div class="form-group row">
                                    <div class="input-group ">
                                        <div class="form-control ">
                                            <input type="file" class="form-control custom-file-input" placeholder="ملف مرفق" name="files[]">
                                        </div>
...
<script>
    ...
    <script type="text/javascript"
    src="{{ asset('assets/js/custom/images.js') }}?t={{ config('global.ver.version_all') }}"></script>
