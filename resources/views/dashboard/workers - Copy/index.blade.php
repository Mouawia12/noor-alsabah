                    ...
                    <div class="card-body px-1">
                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-bold fs-6 text-dark">صورة الشخصية للعامل</label>
                                    <div class="col-lg-8">
                                ...
                                <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5 border-success border ">
                                    ...
                                    <div
                                        class=" fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-invalid">
