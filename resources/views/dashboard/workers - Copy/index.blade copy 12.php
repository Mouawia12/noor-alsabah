...
@section('content')
    ...
    <form id="save_workers" id="save_workers" name="save_workers" class="form" action="{{ route('dashboard.workers.store') }}" enctype="multipart/form-data"  autocomplete="off">
        @csrf
                                        ...
                                        <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                            ...
                                            <div>
                                                <!--<select class="form-select form-select-solid" name="filter_4" id="filter_4">-->
                                                    <select class="form-select form-select-solid" data-control="select2" id="sex" name="sex" dir="rtl"  data-placeholder="اختر التصنيف"  data-allow-clear="true">
...
@section('scripts')
    ...
    <script src="{{asset('assets/form-validation/bundle/lib/popular.js')}}"  ></script>

    <script src="{{asset('assets/plugins/formvalidation/dist/js//plugins/Tachyons.min.js')}}"  ></script>

    <script src="{{asset('assets/form-validation/plugin-l10n/lib/index.js')}}"  ></script>

    <script src="{{asset('assets/form-validation/locales/lib/ar_MA.js')}}"  ></script>
