                        ...
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="financial_month_desc_v" class="form-label required fs-6 fw-bold text-dark mb-3">شهر الدفع
                                        :</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                            type="text" name="financial_month_desc_v" id="financial_month_desc_v"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_fnancial_pdf') }}'
                                               onclick="print_fnancial_pdf('')" class="menu-link px-3 text-dark print_fnancial_pdf "><span><i
                                        ...
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_fnancial_xlsx') }}'
                                               ...
                                               class="menu-link px-3 text-dark print_fnancial_xlsx"><span><i
