...
<form id="upd_statement_data" name="upd_statement_data" class="form" action="{{ route('dashboard.financial.updstatement') }}"
    method="post" enctype="multipart/form-data" autocomplete="off">
    @csrf


    <input name="financial_id_db" id="financial_id_db" value="{{ $financial->financial_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="financial_id_db"
        aria-describedby="basic-addon1">

        <input name="worker_id" id="worker_id" value="{{ $financial->worker_id }}" im-insert="true"
        data-inputmask="'alias' : 'integer' " type="text" style="display:none"
        ...
        <input name="financial_month_desc" id="financial_month_desc" value="{{ $financial->financial_month_desc }}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="financial_month_desc"
        aria-describedby="basic-addon1">


        <input name="financial_month_y" id="financial_month_y" value="{{ $financial->financial_month_y }}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="financial_month_y"
        aria-describedby="basic-addon1">

        <input name="financial_month_m" id="financial_month_m" value="{{ $financial->financial_month_m}}" im-insert="true"
        type="text" style="display:none"
        class="form-control kt-font-dark kt-font-bolder " readonly placeholder="financial_month_m"
        aria-describedby="basic-addon1">
        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
            ...
            <div class="card">
                ...
                <div class="row p-0 mb-0 px-1">
                    ...
                    <div class="col">
                        <div class="border border-dashed border-dark text-center min-w-125px  rounded pt-4 pb-2 my-3">
                            <span class="fs-6 fw-bold text-danger ">شهر الدفع:</span> <span class=" fw-bold text-dark ">{{ $financial->financial_month_desc}}</span> 														
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5" id='show_details'>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5" style="display:none">
                                <label for="financial_detail_id" class="form-label required fs-6 fw-bold text-dark mb-3">financial_detail_id</label>
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                                        ...
                                        class="form-control fw-bold text-dark text-info form-control-solid"
                                        data-inputmask="'alias' : 'decimal'" minlenght="1" maxlength="20" value="{{ $last_financial_month_remain }}"
                                        placeholder="المبلغ المطلوب ">
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                    ...
                    <div id="result_financial_detail_tbl" name="result_financial_detail_tbl"></div>
                </div>
            </div>
        </div>
...
<script>
        view_all_financial_detail("{{ route('dashboard.financial.tbl_detail') }}");



        function del_financial_det(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.financial.del_financial_det') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
...
$('#financial_month_val').val(resp.financial_month_val);
calc_all_price() ;
...
var year=year_val;
    ...
    if(worker_id!=''){
$.ajax({
url: " {{ route('dashboard.general.chk_financial') }}",
dataType: 'json',
type: 'POST',
async: false,
'data': {
...
$("#errorBox_financial").show();
        ...
        $('#displayErrors_financial').append('<p>'+resp.message+'</p');
...
$(document).ready(function() {
    ...
    onChange: function(selectedDates, dateStr, instance) {
        chk_financial(selectedDates[0].getMonth() + 1,selectedDates[0].getFullYear())
  },
