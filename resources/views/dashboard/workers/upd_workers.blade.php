                ...
                <div class="card-body ">
                    ...
                    <div class="mb-0">
                        <div class="row gx-5 mb-5">
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="mobile" class="form-label  fs-6 fw-bold text-dark mb-3">رقم هاتف
                                    الموظف</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i
                            ...
                            <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                <label for="manager_id" class="form-label   fs-6 fw-bold text-dark mb-3">قائد المجموعة</label>
                                <div>
                                    <select class="form-select fw-bold form-select_u  " data-control="select2"
...
if($emp_job==1){
                            ...
                            <div class="separator separator-content border-dark my-10 mb-8"><span
                                ...
                                aria-describedby="basic-addon1">
                        <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                            <label for="health_no" class="form-label  fs-6 fw-bold text-dark mb-3">رقم الشهادة </label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="fas fa-passport fa-fw text-dark"></i></span></div><input
                        ...
                        <div class=" col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                            <label for="health_edt" class="form-label  fs-6 fw-bold text-dark mb-3">تاريخ الانتهاء</label>
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i
                                            class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
        ...
        if($emp_job==1){
                       @endphp
                        ...
                        <div class=" col-12 col-lg-12 col-md-12 col-sm-12  mb-5">
                            <label for="health_note" class="  form-label fs-6 fw-bold text-dark mb-3">الملاحظة
                            </label>
