...
<div class="row p-0 mb-1 px-9">
    ...
    <div class="col">
        <div class="border border-dashed border-gray-800 text-center min-w-150px rounded ">
            <span class="fs-4 fw-bold text-primary d-block"> ليس لديهم مجموعة</span>
            <span class="fs-2hx fw-bolder text-gray-900 counted" data-kt-countup="true"    id='not_have_manger' name='not_have_manger' style="font-size: 1.5rem !important;"></span>
        </div>
    </div>
    ...
    <div class="col">
        <div class="border border-dashed border-gray-800 text-center min-w-150px rounded ">
            ...
            <span class="fs-2hx fw-bolder text-gray-900 counted" data-kt-countup="true"    id='out_ksa' name='out_ksa' style="font-size: 1.5rem !important;"></span>
        </div>
    </div>
    ...
    <div class="col">
        <div class="border border-dashed border-gray-800 text-center min-w-150px rounded ">
            ...
            <span class="fs-2hx fw-bolder text-gray-900 counted" data-kt-countup="true"    id='in_ksa' name='in_ksa' style="font-size: 1.5rem !important;"></span>
        </div>
    </div>
    ...
    <div class="col">
        <div class="border border-dashed border-gray-800 text-center min-w-150px rounded ">
            ...
            <span class="fs-2hx fw-bolder text-gray-900 counted" data-kt-countup="true"    id='all_imp_not_cancal' name='all_imp_not_cancal' style="font-size: 1.5rem !important;"></span>
        </div>
    </div>
    <div class="col">
        <div class="border border-dashed border-gray-800 text-center min-w-150px rounded ">
            <span class="fs-4 fw-bold text-orange d-block">المنهي خدماته</span>
            <span class="fs-2hx fw-bolder text-gray-900 counted" data-kt-countup="true"  id='all_cancal' name='all_cancal' style="font-size: 1.5rem !important;"></span>
        </div>
    </div>
</div>
   <div class="py-5">
