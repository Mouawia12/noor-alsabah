...
@section('content')
    ...
    <form class="kt-form kt-form--label-right" enctype="multipart/form-data" id="boew_project" name="boew_project"
        accept-charset="utf-8" method="post" action="{{ route('dashboard.violation.tbl') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
                <div class="card">
                    <div class="card-body px-1">
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
                                    <label for="shop_id_v" class="form-label required fs-6 fw-bold text-dark mb-3">اسم
                                        المحل</label>
                                    <div>
                                        <select class="form-select fw-bolder  shop_id_v  " id="shop_id_v"
                                            name="shop_id_v" dir="rtl" data-placeholder="اسم المحل">
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="violation_no_v" class="form-label  fs-6 fw-bold text-dark mb-3">رقم المخالفة</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="fas fa-hashtag fa-fw text-dark text-dark"></i></span></div><input
                                            type="text" name="violation_no_v" id="violation_no_v"
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="violation_ispay_v" class="form-label  fs-6 fw-bold text-dark mb-3">حالة دفع المخالفة</label>
                                    <div>
                                        <select class="form-select fw-bold" data-control="select2" id="violation_ispay_v"
                                            name="violation_ispay_v" dir="rtl" >
                                            <option value="">الكل</option>
                                ...
                                <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="violation_month_desc_v" class="form-label required fs-6 fw-bold text-dark mb-3">شهر المخالفة
                                        :</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="far fa-calendar-alt fa-fw text-dark"></i></span></div><input
                                            type="text" name="violation_month_desc_v" id="violation_month_desc_v"
                                            class="form-control fw-bold  text-dark input_date_full_"
                                            placeholder="شهر المخالفة " value="" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                                    class="fas fa-crop-alt fa-fw text-dark"></i></span></div><input
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12   mb-5"
                                    ...
                                    <a onclick="view_all_violation()" class="btn btn-primary btn-primary--icon"
                                        id="kt_search">
                                        <span>
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_violation_pdf') }}'
                                               onclick="print_violation_pdf('')" class="menu-link px-3 text-dark print_violation_pdf "><span><i
                                                        class="far fa-file-pdf fa-fw text-danger"></i></span> طباعة PDF
                                            </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_violation_xlsx') }}'
                                               onclick="print_violation_xlsx('')"
                                               class="menu-link px-3 text-dark print_violation_xlsx"><span><i
                                                        class="fas fa-file-excel fa-fw text-success"></i></span>طباعة
                                                EXCEL
                                            </a>
                                        </div>
                                    </div>                                    <button type="button" class="btn btn-secondary btn-secondary--icon" name="refresh"
                        ...
                        <div id="result_violation_tbl" name="result_violation_tbl">
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        view_all_violation("{{ route('dashboard.violation.tbl') }}");
        function del_violation (id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.violation.del_violation') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
