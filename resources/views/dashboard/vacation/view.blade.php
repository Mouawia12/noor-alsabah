...
@section('content')
    ...
    <form class="kt-form kt-form--label-right" enctype="multipart/form-data" id="boew_project" name="boew_project"
        accept-charset="utf-8" method="post" action="{{ route('dashboard.vacation.tbl') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 ">
                <div class="card">
                    <div class="card-body px-1">
                        <div class="mb-0">
                            <div class="row gx-5 mb-5">
                                ...
                                <div class=" col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="vacation_month_desc_v"
                                        class="form-label required fs-6 fw-bold text-dark mb-3">شهر:</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i
                                            ...
                                            class="form-control fw-bold  text-dark input_date_full2_" placeholder="الشهر"
                                ...
                                <div class="col-12 col-lg-4 col-md-12 col-sm-12 mb-5">
                                    <label for="worker_id_v" class="form-label  fs-6 fw-bold text-dark mb-3">اسم
                                        الموظف</label>
                                    <div>
                                ...
                                <div class="col-12 col-lg-2 col-md-12 col-sm-12 mb-5">
                                    <label for="vacation_type_id_v" class="form-label   fs-6 fw-bold text-dark mb-3">نوع
                                        الاجازة</label>
                                    <div>
                                        <select class="form-select fw-bolder  vacation_type_id_v " data-control="select2"
                                            id="vacation_type_id_v" name="vacation_type_id" dir="rtl">
                                            <option value="">الكل</option>
                                            @foreach ($vacation_type as $x)
                                                <option value="{{ $x->vacation_type_id }} ">{{ $x->vacation_type_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-lg-3 col-md-12 col-sm-12   mb-5"
                                    ...
                                    <a onclick="view_all_vacation()" class="btn btn-primary btn-primary--icon"
                                        id="kt_search">
                                        <span>
                                    ...
                                    <button type="button" class="btn btn-dark" data-kt-menu-trigger="click"
                                        data-kt-menu-placement="bottom-start"> <i class="fas fa-print fa-fw"></i> تقارير
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_vacation_pdf') }}'
                                                onclick="print_vacation_pdf('')" class="menu-link px-3 text-dark print_vacation_pdf "><span><i
                                                        class="far fa-file-pdf fa-fw text-danger"></i></span> طباعة PDF </a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a data-url='{{ route('dashboard.report.print_vacation_xlsx') }}'
                                                onclick="print_vacation_xlsx('')"
                                                class="menu-link px-3 text-dark print_vacation_xlsx"><span><i
                                                        class="fas fa-file-excel fa-fw text-success"></i></span>طباعة EXCEL
                                            </a>
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-secondary btn-secondary--icon" name="refresh"
                                        id="refresh" id="boew_project">
                                        <span>
                        ...
                        <div id="result_vacation_tbl" name="result_vacation_tbl">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl " data-bs-focus="false">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="btn btn-icon btn-sm btn-danger fs-9  mb-0 " data-bs-dismiss="modal" aria-label="Close">
                        <i class="far fa-times-circle fa-fw text-light fw-bolder"></i>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        view_all_vacation("{{ route('dashboard.vacation.tbl') }}");
        ...
        function del_vacation(id) {
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('dashboard.vacation.del_vacation') }}",
                        'type': 'POST',
                        'dataType': 'json',
                        'async': false,
                        'data': {
