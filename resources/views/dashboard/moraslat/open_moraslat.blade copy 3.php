...
<form id="open_moraslat_data" name="open_moraslat_data" class="form" action="{{ route('dashboard.moraslat.updopenstore') }}"
                    ...
                    <div class="mb-0 py-5" >
                        ...
                        <div class="row gx-5 mb-5">
                            <div class="col-12 col-lg-3 col-md-12 col-sm-12 mb-5">
                                <label for="moraslat_status_id" class="form-label   fs-6 fw-bolder text-danger mb-3">نوع الاجراء</label>
                                <div>
                                    <select class="form-select fw-bolder text-danger moraslat_status_id form-select_u "
                                        ...
                                        @foreach ($moraslat_status as $x)
                                            <option @selected($moraslat->moraslat_status_id == $x->moraslat_status_id) value="{{ $x->moraslat_status_id }} ">
