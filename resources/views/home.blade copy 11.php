...
//     +"update_user": 1
//     +"updated_at": "2023-09-12 02:10:09"
//     +"is_read": 0
//     +"read_dt": "0000-00-00 00:00:00"
//     +"moraslat_status_id": 3
//     +"status_note": "تجربه-وارجو الانتباه"
//     +"status_dt": "2023-09-12 02:14:27"
//     +"emp_name": "سامر"
//     +"name": "مهند ابراهيم السميري"
//     +"moraslat_type_name": "معاملة محل"
//     +"moraslat_categoty_name": "هام و عاجل"
//     +"shop_name": "مجموعة شركة هنقر ستيشن"
//     +"worker_name": null
//     +"moraslat_status_name": "ارجاع"
                    ...
                    $is_read_desc = 'مقروء';
                    //$is_read_desc .=  $x->moraslat_status_name;
                } else {
...
<?php } ?>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-info">احصائيات المالية -{{$Carbon::now()->format('Y')}}</span>
                        <span class="text-muted mt-1 fw-bold fs-7">dd</span>
                    </h3>
        ...
        {{-- <div class="col-xl-4">
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-info">احصائيات المالية -{{$Carbon::now()->format('Y')}}</span>
                        <span class="text-muted mt-1 fw-bold fs-7">{{ $sum_c1 }}</span>
                    </h3>
    ...
    <div class="row g-5 g-xxl-8 mt-4" style="background-color: #fff !important">


        <div class="col-xl-3">
            <div class="card " style="border: 1px solid #0abb87 !important;">
