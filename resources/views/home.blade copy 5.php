                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-warning fw-bold ">ادخال بيانات المشغل</a>
                                    <br>
                                    <a href="#" class="text-warning fw-bold ">عرض بيانات المشغل</a>
                                    <br>
                                    <a href="#" class="text-warning fw-bold ">ادخال الطلبات</a>
                                ...
                                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-primary fw-bold ">التشغيل المؤقت</a>
                                    <br>
                                    <a href="#" class="text-primary fw-bold ">عرض بيانات التشغيل المؤقت</a>
                                ...
                                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-primary fw-bold ">طلب اجازة مهنية</a>
                                ...
                                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-danger fw-bold ">طلب افادة متعطل عن العمل</a>
                                </div>
