...
<head><base href="../../">
<title>شركة نور الصباح الاستثمارية || النظام المالي - @yield('title','لوحة التحكم')</title>
<meta name="description" content="شركة نور الصباح الاستثمارية || النظام المالي" />
<meta name="keywords" content="" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="csrf-token" content="{{ csrf_token() }}">
<meta charset="utf-8" />
<meta property="og:locale:alternate" content="ar_SA" />
<meta property="og:type" content="شركة نور الصباح الاستثمارية || النظام المالي" />
<meta property="og:title" content="شركة نور الصباح الاستثمارية || النظام المالي" />
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" onclick=' load_alerts("{{ route("load_alerts") }}");'>
                                    <div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        ...
                                        <span class="position-absolute top-0 start-0  translate-middle  badge badge-circle badge-danger   animation-blink" id='count_moraslat' name='count_moraslat'></span>
                                    </div>
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-300px" data-kt-menu="true">
                                            ...
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-8">@auth(){{Auth::user()->name}} @else User Name @endauth
                                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">@auth(){{Auth::user()->role_id != null ? Auth::user()->role->name :''}} @else Employee @endauth</span>
                                                    </div>
                                        ...
                                        <div class="menu-item px-5 my-1">
                                            <a href="{{route('edit_profile')}}" class="menu-link px-5 text-info">إعدادات الحساب</a>
                                        </div>
                                          <div class="separator my-2"></div>
                                        <div class="menu-item px-5">
                                               <div class="menu-item ">
                                                <a class="menu-link px-5 text-red" href="{{ route('logout') }}"
                                        ...
                                        <div class="menu-item px-5">
                                            <div class="menu-content px-5">
                                                <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle">
                                                    ...
                                                    <span class="form-check-label text-gray-600 fs-7">الوضع المظلم</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="toolbar" id="kt_toolbar">
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0" style='background-color: #083da6;' >
                            ...
                            <h1 class="d-flex align-items-center text-light  fs-8 my-1">@yield('sub',"شركة نور الصباح الاستثمارية || النظام المالي")</h1>
                            <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    <div class="text-dark order-2 order-md-1">
                        <a href="#" target="_blank" class=" text-hover-primary fw-bolder text-dark">تم التطوير لدى شركة نور الصباح الاستثمارية</a>
