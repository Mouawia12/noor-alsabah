                    ...
                    <div class="card-body p-0" style="position: relative;">
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col bg-light-info px-1 py-8 rounded-2 me-4 mb-14">
                                ...
                                <div class="col bg-light-success px-1 py-8 rounded-2 me-4 mb-14">
                                    ...
                                    <a href="#" class="text-primary fw-bold "><i class="fas fa-arrow-left fa-fw text-info"></i> طلب افادة متعطل عن العمل</a>
                                </div>
                            </div>
