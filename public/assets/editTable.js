/**
 * Created by mamdo on 19/09/2021.
 */
    ...
    t.fn.Tabledit = function (e) {
        function n(e) {
            ...
            var l = t.post(
                ...
                n,
                function (t, n, a) {
                    e === d.buttons.edit.action &&
                    (s.removeClass(d.dangerClass).addClass(d.warningClass),
                        setTimeout(function () {
            ...
            return (
                l.fail(function (t, n, i) {
                    e === d.buttons["delete"].action
                        ? (o.removeClass(d.mutedClass).addClass(d.dangerClass), o.find(".tabledit-toolbar button").attr("disabled", !1), o.find(".tabledit-toolbar .tabledit-restore-button").hide())
                        : e === d.buttons.edit.action && s.addClass(d.dangerClass),
                        d.onFail(t, n, i);
                }),
                    l.always(function () {
                        d.onAlways();
        ...
        var i = this,
            a = {
                ...
                restoreButton: !0,
                buttons: {
                    edit: { class: "btn btn-sm btn-default", html: '<span class="btn btn-sm btn-clean btn-icon btn-primary"><i class="las la-edit"></i></span>', action: "edit" },
                    delete: { class: "btn btn-sm btn-default", html: '<span class="btn btn-sm btn-clean btn-icon btn-danger"><i class="las la-trash"></i></span>', action: "delete" },
                    save: { class: "btn btn-sm btn-success", html: "حفظ" },
                    restore: { class: "btn btn-sm btn-warning", html: "Restore", action: "restore" },
                    confirm: { class: "btn btn-sm btn-danger", html: "تأكيد" },
                },
                onDraw: function () {},
                onSuccess: function () {},
                onFail: function () {},
                    ...
                    toolbar: function () {
                        if (d.editButton || d.deleteButton) {
                            var t = "",
                                ...
                                a = "",
                                s = "";
                            0 === i.find("th.tabledit-toolbar-column").length && i.find("tr:first").append('<th class="tabledit-toolbar-column">الإجراءات</th>'),
                            d.editButton && (t = '<button type="button" class="tabledit-edit-button ' + d.buttons.edit["class"] + '" style="float: none;padding: 0 !important;margin: 0 !important;">' + d.buttons.edit.html + "</button>"),
                            d.deleteButton &&
                            ((e = '<button type="button" class="tabledit-delete-button ' + d.buttons["delete"]["class"] + '" style="float: none;padding: 0 !important;margin: 0px 10px !important;">' + d.buttons["delete"].html + "</button>"),
                                (s = '<button type="button" class="tabledit-confirm-button ' + d.buttons.confirm["class"] + '" style="display: none; float: none;padding: 3px 19px 9px !important;font-weight: 600;">' + d.buttons.confirm.html + "</button>")),
                            d.editButton && d.saveButton && (n = '<button type="button" class="tabledit-save-button ' + d.buttons.save["class"] + '" style="display: none; float: none;padding: 3px 19px 9px !important;font-weight: 600;">' + d.buttons.save.html + "</button>"),
                            d.deleteButton &&
                            d.restoreButton &&
                            (a = '<button type="button" class="tabledit-restore-button ' + d.buttons.restore["class"] + '" style="display: none; float: none;padding: 3px 19px 9px !important;font-weight: 600;">' + d.buttons.restore.html + "</button>");
                            var o =
            ...
            u = {
                view: function (e) {
                    var n = t(e).parent("tr");
                    t(e).parent("tr").find(".tabledit-input.tabledit-identifier").prop("disabled", !0),
                        t(e).find(".tabledit-input").blur().hide().prop("disabled", !0),
                        t(e).find(".tabledit-span").show(),
                        t(e).addClass("tabledit-view-mode").removeClass("tabledit-edit-mode"),
                    d.editButton && (n.find("button.tabledit-save-button").hide(), n.find("button.tabledit-edit-button").removeClass("active").blur());
                },
                edit: function (e) {
                    c.reset(e);
                    var n = t(e).parent("tr");
                    ...
                    i.prop("disabled", !1).show(),
                    d.autoFocus && i.focus(),
                        t(e).addClass("tabledit-edit-mode").removeClass("tabledit-view-mode"),
                    d.editButton && (n.find("button.tabledit-edit-button").addClass("active"), n.find("button.tabledit-save-button").show());
                },
            },
            b = {
                reset: function (e) {
                ...
                submit: function (e) {
                    ...
                    (t(e).each(function () {
                        ...
                        t(this)
                            .find(".tabledit-span")
                            .text(e.is("select") ? e.find("option:selected").text() : e.val()),
                            u.view(this);
                    }),
                        (s = t(e).parent("tr")));
                },
            ...
            c = {
                ...
                submit: function (e) {
                    ...
                    i !== !1 &&
                    (t(e).parent("tr").addClass("tabledit-deleted-row"),
                        t(e).parent("tr").addClass(d.mutedClass).find(".tabledit-toolbar button:not(.tabledit-restore-button)").attr("disabled", !0),
                        t(e).find(".tabledit-restore-button").show(),
                        (o = t(e).parent("tr")));
                },
                confirm: function (e) {
                    i.find("td.tabledit-edit-mode").each(function () {
                        ...
                        t(e).find(".tabledit-delete-button").addClass("active"),
                        t(e).find(".tabledit-confirm-button").show();
                },
                restore: function (e) {
                    ...
                    t(e).parents("tr").find("input.tabledit-identifier").attr("disabled", !0),
                    i !== !1 &&
                    (t(e).parent("tr").removeClass("tabledit-deleted-row"),
                        t(e).parent("tr").removeClass(d.mutedClass).find(".tabledit-toolbar button").attr("disabled", !1),
                        t(e).find(".tabledit-restore-button").hide(),
                        (l = t(e).parent("tr")));
                },
            };
        return (
            r.columns.identifier(),
                r.columns.editable(),
                r.columns.toolbar(),
                d.onDraw(),
            d.deleteButton &&
            (i.on("click", "button.tabledit-delete-button", function (e) {
                if (e.handled !== !0) {
                    e.preventDefault();
            ...
            d.restoreButton &&
            i.on("click", "button.tabledit-restore-button", function (e) {
                e.handled !== !0 && (e.preventDefault(), c.restore(t(this).parents("td")), (e.handled = !0));
            }),
                d.editButton
                    ? (i.on("click", "button.tabledit-edit-button", function (e) {
                    if (e.handled !== !0) {
                        e.preventDefault();
                        var n = t(this),
                            a = n.hasClass("active");
                        b.reset(i.find("td.tabledit-edit-mode")),
                        a ||
                        t(n.parents("tr").find("td.tabledit-view-mode").get().reverse()).each(function () {
                            u.edit(this);
                        }),
                            (e.handled = !0);
                    }
