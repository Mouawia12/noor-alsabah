        ...
        table.DataTable({
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: [
                        'order_no', 'inv_type','side_id','tottal_price','cur','status', 'created_at','actions'],
                    from_date:from_date,
                    to_date:to_date,
                    filter_1:filter_1,
                    filter_2:filter_2,
            ...
            columns: [
                {data: 'order_no',width: 130},
                // {data: 'year',width: 150},
                {data: 'inv_type',width: 180},
                {data: 'side_id',width: 180},
                {data: 'tottal_price',width: 180},
                {data: 'cur',width: 180},
                {data: 'status',width: 180},
                {data: 'created_at', width: 150},
                {data: 'actions',width: 450},
            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                        if(full.status1 == 117){
                            var add_item_ = '<a href="javascript:;" onclick="return add_item_('+full.inv_id_pk+')" class="btn btn-sm btn-clean btn-icon btn-info" title="إضافة صنف">\
								<i class="las la-plus"></i>\
							</a>';

                            var updated_ = '<a href="javascript:;" onclick="return updated_('+full.inv_id_pk+')" class="btn btn-sm btn-clean btn-icon btn-primary" title="تعديل">\
							...
							'+add_item_+'\
                                '+updated_+'\
                                <a href="'+SITEURL+'/stock/invoices/'+full.inv_id_pk+'" class="btn btn-sm btn-clean btn-icon btn-secondary" title="تفاصيل الفاتورة">\
