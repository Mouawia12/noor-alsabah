        ...
        table.DataTable({
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: ['id_no','cont_name','type','governorate','reg_date','status','actions'],
                    from_date:from_date,
                    to_date:to_date,
                    filter_1:filter_1,
                    filter_2:filter_2,
            ...
            columns: [
                {data: 'id_no',width: 120},
                {data: 'cont_name',width: 180},
                {data: 'type',width: 180},
                {data: 'governorate',width: 180},
                {data: 'reg_date',width: 180},
            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                        console.log(full);
                            return '\
                             <a href="cooperatives/'+full.id+'/edit" class="btn btn-sm btn-clean btn-icon btn-primary">\
