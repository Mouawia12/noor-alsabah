        ...
        table.DataTable({
            ...
            ajax: {
                ...
                data: {
                    ...
                    columnsDef: [
                        'id','name','category','unit','qty','custody', 'status', 'created_at','actions'],
                    from_date:from_date,
                    to_date:to_date,
                    filter_1:filter_1,
                    filter_2:filter_2,
            ...
            columns: [
                {data: 'id',width: 120},
                {data: 'name',width: 180},
                {data: 'category',width: 180},
                {data: 'unit',width: 180},
                {data: 'qty',width: 180},
                {data: 'custody',width: 180},
                {data: 'status',width: 150},
                {data: 'created_at', width: 170},
            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                            return '\
							<a href="javascript:;" onclick="return updated_('+full.id_pk+')" class="btn btn-sm btn-clean btn-icon btn-primary" title="تعديل">\
								<i class="las la-edit"></i>\
							</a>\
                            <a href="'+SITEURL+'/stock/item_records/'+full.id_pk+'" class="btn btn-sm btn-clean btn-icon btn-secondary" title="حركة الصنف">\
                            <i class="las la-list"></i>\
							</a>\
							<a href="javascript:;" onclick="return stock_qty('+full.id_pk+')" class="btn btn-sm btn-clean btn-icon btn-warning" title="أرصدة المخازن">\
