...
class Purchase extends Model
{
    ...
    public function scopeserachspendcount($query, $purchase_no, $purchase_dt_from, $purchase_dt_to, $purchase_respon, $manager_id, $shop_id, $shops , $create_users, $created_at_date = null)
    {
    ...
    public function scopeserachspenddata($query, $purchase_no, $purchase_dt_from, $purchase_dt_to, $purchase_respon, $manager_id, $shop_id, $shops , $create_users, $created_at_date = null)
    {
        $a = $_POST['length'];
        $b = $_POST['start'];
        $purchase_no = TRIM($purchase_no);
