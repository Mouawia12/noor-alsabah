...
class PurchaseController extends Controller
{
    ...
    public function ajax_search_purchase(Request $request)
    {
        if ($request->ajax() and (Perm::get_function_access(56) || Perm::get_function_access(57) || Perm::get_function_access(58))) {
            ...
            $list_total = Purchase::serachspendcount($purchase_no, $purchase_dt_from, $purchase_dt_to, $purchase_respon, $manager_id, $shop_id, $request->shops, $create_users, $created_at_date);
            $list = Purchase::serachspenddata($purchase_no, $purchase_dt_from, $purchase_dt_to, $purchase_respon, $manager_id, $shop_id, $request->shops, $create_users, $created_at_date);
            $data = array();
            $no = $_POST['start'];
            $i = 0;
            foreach ($list as $x) {
