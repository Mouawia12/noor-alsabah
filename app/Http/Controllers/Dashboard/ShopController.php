...
<div class="fw-bold text-info">' . $sc_desc_char . '</div>';
    ...
    ';
                            ...
                            if (Perm::get_function_access(34)) {
                                $opt .= '<li><a class="dropdown-item  fw-bolder  text-dark"  onclick="del_shop(' . "'" . $x->shop_id . "'" . ')">  <i class="fas fa-trash-alt fa-fw fa-fw text-danger"></i> حذف محل</a></li>';
                            }
                                ...
                                $opt .= '
            <li><a class="dropdown-item print_shop_pdf fw-bolder  text-dark"   data-url=' . "'" . route('dashboard.report.print_shop_pdf') . "'" . ' onclick="print_shop_pdf(' . "'" . $x->shop_id . "'" . ')">  <i class="fas fa-print fa-fw fa-fw text-primary"></i> طباعة</a></li>
            ';
...
';
                        ...
                        ';
                        $opt = $opt . '<div class="separator my-2 fw-bolder  text-info" ></div>
</ul>
</div>';
                    }
                    $opt .= '</div>';
