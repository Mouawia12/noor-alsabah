...
';
                        ...
                        if (Perm::get_function_access(13)) {
                            $opt .= '<li><a class="dropdown-item  fw-bolder  text-dark"  onclick="del_workers(' . "'" . $x->worker_id . "'" . ')">  <i class="fas fa-trash-alt fa-fw fa-fw text-danger"></i> حذف عامل</a></li>';
                        }
...
';
                        ...
                        if (Perm::get_function_access(14)) {
                            $opt .= '
        <li><a class="dropdown-item print_worker_pdf fw-bolder  text-dark"   data-url=' . "'" . route('dashboard.report.print_worker_pdf') . "'" . ' onclick="print_worker_pdf(' . "'" . $x->worker_id . "'" . ')">  <i class="fas fa-print fa-fw fa-fw text-primary"></i> طباعة</a></li>
        ';
                        }
                        if (Perm::get_function_access(72)) {
       ...
       ';
                        ...
                        $opt .= '
    <div class="separator my-2 fw-bolder  text-info" ></div>
    </ul>
    </div>';
                    }
