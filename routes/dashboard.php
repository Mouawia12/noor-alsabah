...
Route::group([
    ...
    function () {
        ...
        Route::get('/calculate/cronadd', [calculateController::class, 'cronadd'])->name('calculate.cronadd');
        ...
        Route::get('/financial/cronadd', [financialController::class, 'cronadd'])->name('financial.cronadd');
        ...
        Route::post('/financial/financial_note_ر', [financialController::class, 'financial_note_history'])->name('financial.financial_note_history');
...
//Route::get('/upload/delete_file/{id}', [UploadController::class,'delete_file'])->name('upload.delete_file');
        ...
        Route::post('/rent/ai/approve-all', [RentAiController::class, 'approveAll'])->name('rent.ai.approve_all');
        ...
        Route::get('/rent/payment-match/export', [PaymentMatchController::class, 'export'])->name('rent.payment_match.export');
        ...
        Route::post('/expense/updstatement', [expenseController::class, 'updstatement'])->name('expense.updstatement');
        Route::post('/expense/tbl_detail', [expenseController::class, 'tbl_detail'])->name('expense.tbl_detail');
        Route::post('/expense/del_expense_det', [expenseController::class, 'del_expense_det'])->name('expense.del_expense_det');
        Route::post('/general/chk_expense_worker', [GeneralController::class, 'chk_expense_worker'])->name('general.chk_expense_worker');
        Route::post('/general/chk_expense_shop', [GeneralController::class, 'chk_expense_shop'])->name('general.chk_expense_shop');
